...
// // ========== MIDDLEWARE SETUP ==========
// // BULLETPROOF CORS HANDLING FOR VERCEL

// // 1. MANUAL CORS MIDDLEWARE (placed BEFORE bodyParser)
// app.use((req, res, next) => {
//   const allowedOrigins = [
//     'https://ticketbari-projects.web.app',
//     'https://ticketbari-project.vercel.app',
//     'http://localhost:3000',
//     'http://localhost:5173'
//   ];
...
// // 2. Body parser (AFTER CORS middleware)
// app.use(bodyParser.json());

// // 3. SPECIFIC OPTIONS HANDLER for all routes
// app.options('*', (req, res) => {
//   console.log(`🔄 OPTIONS request for: ${req.url}`);
//   res.setHeader('Access-Control-Allow-Origin', 'https://ticketbari-projects.web.app');
//   res.setHeader('Access-Control-Allow-Credentials', 'true');
//   res.setHeader('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS, PATCH');
...
// // 4. Add logging middleware to debug CORS
// app.use((req, res, next) => {
...
// //   console.log("   5. Test: GET /api/user/dashboard");
// //   console.log("=".repeat(70));
// // });
// module.exports = app;
